...
```
### Licence 
NetCalib is released under a [GPLv3.0](https://github.com/simonwu53/NetCalib-Lidar-Camera-Auto-calibration/blob/master/LICENSE) license. For a list of all source code dependencies, please see .......

For a closed-source version of NetCalib for commercial purposes, please contact the authors: [Link]()


### Contributors
Shan Wu; Amnir Hadachi; Damien Vivet; Yadu Prahbakar.  
